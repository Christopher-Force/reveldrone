...
export default function Footer() {
  ...
  <div>
    <span class="footer-title">Products and services</span> 
    <a class="link link-hover">Consumer</a> 
    <a class="link link-hover">Professional</a> 
    <a class="link link-hover">Accessories</a> 
    <a class="link link-hover">Repair</a>
  </div> 
  <div>
    <span class="footer-title">RevelDrone</span> 
